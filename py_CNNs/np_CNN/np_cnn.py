# This module implements a Convolutional Neural Network (CNN) with the following functionalities:
# - Initialization of convolutional and fully connected layers, including batch normalization parameters.
# - Forward propagation with convolution, max pooling, dropout, and batch normalization.
# - Backward propagation for updating weights and biases using gradients.
# - Parameter updates using gradient descent.
# - Helper functions for ReLU activation, its derivative, and batch normalization operations.
