...
def checkBatchGradient():
  ...
  for j in range(len(tocheck)):
    ...
    for i in range(mat.size):
      ...
      # print stats
      print (f"{status} checking param {name} index {np.unravel_index(i, mat.shape)} (val = {old_val}), analytic = {grad_analytic}, numerical = {grad_numerical}, relative error = {rel_error}")
